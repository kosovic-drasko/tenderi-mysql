...
class VrednovanjeResourceIT {
    ...
    @Test
    @Transactional
    void getAllVrednovanjesBySifraPostupkaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where sifraPostupka not equals to DEFAULT_SIFRA_POSTUPKA
        defaultVrednovanjeShouldNotBeFound("sifraPostupka.notEquals=" + DEFAULT_SIFRA_POSTUPKA);

        // Get all the vrednovanjeList where sifraPostupka not equals to UPDATED_SIFRA_POSTUPKA
        defaultVrednovanjeShouldBeFound("sifraPostupka.notEquals=" + UPDATED_SIFRA_POSTUPKA);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesBySifraPonudeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where sifraPonude not equals to DEFAULT_SIFRA_PONUDE
        defaultVrednovanjeShouldNotBeFound("sifraPonude.notEquals=" + DEFAULT_SIFRA_PONUDE);

        // Get all the vrednovanjeList where sifraPonude not equals to UPDATED_SIFRA_PONUDE
        defaultVrednovanjeShouldBeFound("sifraPonude.notEquals=" + UPDATED_SIFRA_PONUDE);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByBrojPartijeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where brojPartije not equals to DEFAULT_BROJ_PARTIJE
        defaultVrednovanjeShouldNotBeFound("brojPartije.notEquals=" + DEFAULT_BROJ_PARTIJE);

        // Get all the vrednovanjeList where brojPartije not equals to UPDATED_BROJ_PARTIJE
        defaultVrednovanjeShouldBeFound("brojPartije.notEquals=" + UPDATED_BROJ_PARTIJE);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByNazivProizvodjacaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where nazivProizvodjaca not equals to DEFAULT_NAZIV_PROIZVODJACA
        defaultVrednovanjeShouldNotBeFound("nazivProizvodjaca.notEquals=" + DEFAULT_NAZIV_PROIZVODJACA);

        // Get all the vrednovanjeList where nazivProizvodjaca not equals to UPDATED_NAZIV_PROIZVODJACA
        defaultVrednovanjeShouldBeFound("nazivProizvodjaca.notEquals=" + UPDATED_NAZIV_PROIZVODJACA);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByZasticeniNazivIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where zasticeniNaziv not equals to DEFAULT_ZASTICENI_NAZIV
        defaultVrednovanjeShouldNotBeFound("zasticeniNaziv.notEquals=" + DEFAULT_ZASTICENI_NAZIV);

        // Get all the vrednovanjeList where zasticeniNaziv not equals to UPDATED_ZASTICENI_NAZIV
        defaultVrednovanjeShouldBeFound("zasticeniNaziv.notEquals=" + UPDATED_ZASTICENI_NAZIV);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByPonudjenaVrijednostIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where ponudjenaVrijednost not equals to DEFAULT_PONUDJENA_VRIJEDNOST
        defaultVrednovanjeShouldNotBeFound("ponudjenaVrijednost.notEquals=" + DEFAULT_PONUDJENA_VRIJEDNOST);

        // Get all the vrednovanjeList where ponudjenaVrijednost not equals to UPDATED_PONUDJENA_VRIJEDNOST
        defaultVrednovanjeShouldBeFound("ponudjenaVrijednost.notEquals=" + UPDATED_PONUDJENA_VRIJEDNOST);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByRokIsporukeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where rokIsporuke not equals to DEFAULT_ROK_ISPORUKE
        defaultVrednovanjeShouldNotBeFound("rokIsporuke.notEquals=" + DEFAULT_ROK_ISPORUKE);

        // Get all the vrednovanjeList where rokIsporuke not equals to UPDATED_ROK_ISPORUKE
        defaultVrednovanjeShouldBeFound("rokIsporuke.notEquals=" + UPDATED_ROK_ISPORUKE);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByJedinicnaCijenaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where jedinicnaCijena not equals to DEFAULT_JEDINICNA_CIJENA
        defaultVrednovanjeShouldNotBeFound("jedinicnaCijena.notEquals=" + DEFAULT_JEDINICNA_CIJENA);

        // Get all the vrednovanjeList where jedinicnaCijena not equals to UPDATED_JEDINICNA_CIJENA
        defaultVrednovanjeShouldBeFound("jedinicnaCijena.notEquals=" + UPDATED_JEDINICNA_CIJENA);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByNazivPonudjacaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where nazivPonudjaca not equals to DEFAULT_NAZIV_PONUDJACA
        defaultVrednovanjeShouldNotBeFound("nazivPonudjaca.notEquals=" + DEFAULT_NAZIV_PONUDJACA);

        // Get all the vrednovanjeList where nazivPonudjaca not equals to UPDATED_NAZIV_PONUDJACA
        defaultVrednovanjeShouldBeFound("nazivPonudjaca.notEquals=" + UPDATED_NAZIV_PONUDJACA);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByAtcIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where atc not equals to DEFAULT_ATC
        defaultVrednovanjeShouldNotBeFound("atc.notEquals=" + DEFAULT_ATC);

        // Get all the vrednovanjeList where atc not equals to UPDATED_ATC
        defaultVrednovanjeShouldBeFound("atc.notEquals=" + UPDATED_ATC);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByTrazenaKolicinaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where trazenaKolicina not equals to DEFAULT_TRAZENA_KOLICINA
        defaultVrednovanjeShouldNotBeFound("trazenaKolicina.notEquals=" + DEFAULT_TRAZENA_KOLICINA);

        // Get all the vrednovanjeList where trazenaKolicina not equals to UPDATED_TRAZENA_KOLICINA
        defaultVrednovanjeShouldBeFound("trazenaKolicina.notEquals=" + UPDATED_TRAZENA_KOLICINA);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByProcijenjenaVrijednostIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where procijenjenaVrijednost not equals to DEFAULT_PROCIJENJENA_VRIJEDNOST
        defaultVrednovanjeShouldNotBeFound("procijenjenaVrijednost.notEquals=" + DEFAULT_PROCIJENJENA_VRIJEDNOST);

        // Get all the vrednovanjeList where procijenjenaVrijednost not equals to UPDATED_PROCIJENJENA_VRIJEDNOST
        defaultVrednovanjeShouldBeFound("procijenjenaVrijednost.notEquals=" + UPDATED_PROCIJENJENA_VRIJEDNOST);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByVrstaPostupkaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where vrstaPostupka not equals to DEFAULT_VRSTA_POSTUPKA
        defaultVrednovanjeShouldNotBeFound("vrstaPostupka.notEquals=" + DEFAULT_VRSTA_POSTUPKA);

        // Get all the vrednovanjeList where vrstaPostupka not equals to UPDATED_VRSTA_POSTUPKA
        defaultVrednovanjeShouldBeFound("vrstaPostupka.notEquals=" + UPDATED_VRSTA_POSTUPKA);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByBodCijenaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where bodCijena not equals to DEFAULT_BOD_CIJENA
        defaultVrednovanjeShouldNotBeFound("bodCijena.notEquals=" + DEFAULT_BOD_CIJENA);

        // Get all the vrednovanjeList where bodCijena not equals to UPDATED_BOD_CIJENA
        defaultVrednovanjeShouldBeFound("bodCijena.notEquals=" + UPDATED_BOD_CIJENA);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByBodRokIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where bodRok not equals to DEFAULT_BOD_ROK
        defaultVrednovanjeShouldNotBeFound("bodRok.notEquals=" + DEFAULT_BOD_ROK);

        // Get all the vrednovanjeList where bodRok not equals to UPDATED_BOD_ROK
        defaultVrednovanjeShouldBeFound("bodRok.notEquals=" + UPDATED_BOD_ROK);
    }
    ...
    @Test
    @Transactional
    void getAllVrednovanjesByBodUkupnoIsNotEqualToSomething() throws Exception {
        // Initialize the database
        vrednovanjeRepository.saveAndFlush(vrednovanje);

        // Get all the vrednovanjeList where bodUkupno not equals to DEFAULT_BOD_UKUPNO
        defaultVrednovanjeShouldNotBeFound("bodUkupno.notEquals=" + DEFAULT_BOD_UKUPNO);

        // Get all the vrednovanjeList where bodUkupno not equals to UPDATED_BOD_UKUPNO
        defaultVrednovanjeShouldBeFound("bodUkupno.notEquals=" + UPDATED_BOD_UKUPNO);
    }
