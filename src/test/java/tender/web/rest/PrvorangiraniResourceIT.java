...
class PrvorangiraniResourceIT {
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisBySifraPostupkaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where sifraPostupka not equals to DEFAULT_SIFRA_POSTUPKA
        defaultPrvorangiraniShouldNotBeFound("sifraPostupka.notEquals=" + DEFAULT_SIFRA_POSTUPKA);

        // Get all the prvorangiraniList where sifraPostupka not equals to UPDATED_SIFRA_POSTUPKA
        defaultPrvorangiraniShouldBeFound("sifraPostupka.notEquals=" + UPDATED_SIFRA_POSTUPKA);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByNazivPonudjacaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where nazivPonudjaca not equals to DEFAULT_NAZIV_PONUDJACA
        defaultPrvorangiraniShouldNotBeFound("nazivPonudjaca.notEquals=" + DEFAULT_NAZIV_PONUDJACA);

        // Get all the prvorangiraniList where nazivPonudjaca not equals to UPDATED_NAZIV_PONUDJACA
        defaultPrvorangiraniShouldBeFound("nazivPonudjaca.notEquals=" + UPDATED_NAZIV_PONUDJACA);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisBySifraPonudeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where sifraPonude not equals to DEFAULT_SIFRA_PONUDE
        defaultPrvorangiraniShouldNotBeFound("sifraPonude.notEquals=" + DEFAULT_SIFRA_PONUDE);

        // Get all the prvorangiraniList where sifraPonude not equals to UPDATED_SIFRA_PONUDE
        defaultPrvorangiraniShouldBeFound("sifraPonude.notEquals=" + UPDATED_SIFRA_PONUDE);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByBrojPartijeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where brojPartije not equals to DEFAULT_BROJ_PARTIJE
        defaultPrvorangiraniShouldNotBeFound("brojPartije.notEquals=" + DEFAULT_BROJ_PARTIJE);

        // Get all the prvorangiraniList where brojPartije not equals to UPDATED_BROJ_PARTIJE
        defaultPrvorangiraniShouldBeFound("brojPartije.notEquals=" + UPDATED_BROJ_PARTIJE);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByAtcIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where atc not equals to DEFAULT_ATC
        defaultPrvorangiraniShouldNotBeFound("atc.notEquals=" + DEFAULT_ATC);

        // Get all the prvorangiraniList where atc not equals to UPDATED_ATC
        defaultPrvorangiraniShouldBeFound("atc.notEquals=" + UPDATED_ATC);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByTrazenaKolicinaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where trazenaKolicina not equals to DEFAULT_TRAZENA_KOLICINA
        defaultPrvorangiraniShouldNotBeFound("trazenaKolicina.notEquals=" + DEFAULT_TRAZENA_KOLICINA);

        // Get all the prvorangiraniList where trazenaKolicina not equals to UPDATED_TRAZENA_KOLICINA
        defaultPrvorangiraniShouldBeFound("trazenaKolicina.notEquals=" + UPDATED_TRAZENA_KOLICINA);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByProcijenjenaVrijednostIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where procijenjenaVrijednost not equals to DEFAULT_PROCIJENJENA_VRIJEDNOST
        defaultPrvorangiraniShouldNotBeFound("procijenjenaVrijednost.notEquals=" + DEFAULT_PROCIJENJENA_VRIJEDNOST);

        // Get all the prvorangiraniList where procijenjenaVrijednost not equals to UPDATED_PROCIJENJENA_VRIJEDNOST
        defaultPrvorangiraniShouldBeFound("procijenjenaVrijednost.notEquals=" + UPDATED_PROCIJENJENA_VRIJEDNOST);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByNazivProizvodjacaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where nazivProizvodjaca not equals to DEFAULT_NAZIV_PROIZVODJACA
        defaultPrvorangiraniShouldNotBeFound("nazivProizvodjaca.notEquals=" + DEFAULT_NAZIV_PROIZVODJACA);

        // Get all the prvorangiraniList where nazivProizvodjaca not equals to UPDATED_NAZIV_PROIZVODJACA
        defaultPrvorangiraniShouldBeFound("nazivProizvodjaca.notEquals=" + UPDATED_NAZIV_PROIZVODJACA);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByZasticeniNazivIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where zasticeniNaziv not equals to DEFAULT_ZASTICENI_NAZIV
        defaultPrvorangiraniShouldNotBeFound("zasticeniNaziv.notEquals=" + DEFAULT_ZASTICENI_NAZIV);

        // Get all the prvorangiraniList where zasticeniNaziv not equals to UPDATED_ZASTICENI_NAZIV
        defaultPrvorangiraniShouldBeFound("zasticeniNaziv.notEquals=" + UPDATED_ZASTICENI_NAZIV);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByJedinicnaCijenaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where jedinicnaCijena not equals to DEFAULT_JEDINICNA_CIJENA
        defaultPrvorangiraniShouldNotBeFound("jedinicnaCijena.notEquals=" + DEFAULT_JEDINICNA_CIJENA);

        // Get all the prvorangiraniList where jedinicnaCijena not equals to UPDATED_JEDINICNA_CIJENA
        defaultPrvorangiraniShouldBeFound("jedinicnaCijena.notEquals=" + UPDATED_JEDINICNA_CIJENA);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByPonudjenaVrijednostIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where ponudjenaVrijednost not equals to DEFAULT_PONUDJENA_VRIJEDNOST
        defaultPrvorangiraniShouldNotBeFound("ponudjenaVrijednost.notEquals=" + DEFAULT_PONUDJENA_VRIJEDNOST);

        // Get all the prvorangiraniList where ponudjenaVrijednost not equals to UPDATED_PONUDJENA_VRIJEDNOST
        defaultPrvorangiraniShouldBeFound("ponudjenaVrijednost.notEquals=" + UPDATED_PONUDJENA_VRIJEDNOST);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByRokIsporukeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where rokIsporuke not equals to DEFAULT_ROK_ISPORUKE
        defaultPrvorangiraniShouldNotBeFound("rokIsporuke.notEquals=" + DEFAULT_ROK_ISPORUKE);

        // Get all the prvorangiraniList where rokIsporuke not equals to UPDATED_ROK_ISPORUKE
        defaultPrvorangiraniShouldBeFound("rokIsporuke.notEquals=" + UPDATED_ROK_ISPORUKE);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByVrstaPostupkaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where vrstaPostupka not equals to DEFAULT_VRSTA_POSTUPKA
        defaultPrvorangiraniShouldNotBeFound("vrstaPostupka.notEquals=" + DEFAULT_VRSTA_POSTUPKA);

        // Get all the prvorangiraniList where vrstaPostupka not equals to UPDATED_VRSTA_POSTUPKA
        defaultPrvorangiraniShouldBeFound("vrstaPostupka.notEquals=" + UPDATED_VRSTA_POSTUPKA);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByBodCijenaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where bodCijena not equals to DEFAULT_BOD_CIJENA
        defaultPrvorangiraniShouldNotBeFound("bodCijena.notEquals=" + DEFAULT_BOD_CIJENA);

        // Get all the prvorangiraniList where bodCijena not equals to UPDATED_BOD_CIJENA
        defaultPrvorangiraniShouldBeFound("bodCijena.notEquals=" + UPDATED_BOD_CIJENA);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByBodRokIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where bodRok not equals to DEFAULT_BOD_ROK
        defaultPrvorangiraniShouldNotBeFound("bodRok.notEquals=" + DEFAULT_BOD_ROK);

        // Get all the prvorangiraniList where bodRok not equals to UPDATED_BOD_ROK
        defaultPrvorangiraniShouldBeFound("bodRok.notEquals=" + UPDATED_BOD_ROK);
    }
    ...
    @Test
    @Transactional
    void getAllPrvorangiranisByBodUkupnoIsNotEqualToSomething() throws Exception {
        // Initialize the database
        prvorangiraniRepository.saveAndFlush(prvorangirani);

        // Get all the prvorangiraniList where bodUkupno not equals to DEFAULT_BOD_UKUPNO
        defaultPrvorangiraniShouldNotBeFound("bodUkupno.notEquals=" + DEFAULT_BOD_UKUPNO);

        // Get all the prvorangiraniList where bodUkupno not equals to UPDATED_BOD_UKUPNO
        defaultPrvorangiraniShouldBeFound("bodUkupno.notEquals=" + UPDATED_BOD_UKUPNO);
    }
